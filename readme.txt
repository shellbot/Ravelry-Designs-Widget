...
For more info please see [the plugin release page](http://shellbotics.com/wordpress-plugins/ravelry-designs-widget/ "Ravelry Designs Widget")

== Installation ==

1. Upload the 'ravelry-designs-widget' folder to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Add the 'Ravelry Designs' widget to any widget area
4. Enjoy!
